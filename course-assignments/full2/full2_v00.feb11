...
(4) Calculate satisfaction (5) Bonus: Display emoticon translation
Language: Python 3.3
"""
import random
...
print ("You had fun for %d hours and received a fun score of %d." % (fun, fun_point))
print ("\n")
print ("All said and done, your satisfaction is %d." % satisfaction)

# emoticon translation
print ("\nWould you like to display your satisfaction as an emoticon?")
decision = input("Type Y for 'yes' or press any key to exit\n ")
if decision == "Y":
    if satisfaction == 5:
        print (":D")
    elif satisfaction == 4:
